...
\maketitle
\section*{Group 2 - Project Team Members}
\begin{center}
\begin{tabular}{|l|l|}
\hline
\textbf{Student ID} & \textbf{Full Name} \\
\hline
ITITIU22198 & Trần Lưu Hồng Phương \\
\hline
ITITIU22177 & Nguyễn Quốc Tuấn \\
\hline
ITITIU22208 & Nguyễn Phúc Đạt \\
\hline
ITITIU22076 & Lương Quang Huy \\
\hline
ITCSIU22280 & Nguyễn Quách Dịch Thịnh \\
\hline
ITITIU22053 & Nguyễn Đức Hiền \\
\hline
\end{tabular}
\end{center}
...
The ITPM system is a comprehensive academic management platform designed to help students organize their academic life. The system provides integrated features for managing tasks, tracking class schedules, monitoring academic grades, and managing expenses. The application follows modern web development practices with a clear separation between frontend and backend components.
...
The ITPM system follows a three-tier architecture:
